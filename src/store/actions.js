...
export const api_v1_hghfhgjh_list = () => ({ type: types.API_V1_HGHFHGJH_LIST })
export const api_v1_hghfhgjh_listSucceeded = (response, starter) => ({
  type: types.API_V1_HGHFHGJH_LIST_SUCCEEDED,
  response,
  starter
})
export const api_v1_hghfhgjh_listFailed = (error, starter) => ({
  type: types.API_V1_HGHFHGJH_LIST_FAILED,
  error,
  starter
})
export const api_v1_hghfhgjh_create = data => ({
  type: types.API_V1_HGHFHGJH_CREATE,
  data
})
export const api_v1_hghfhgjh_createSucceeded = (response, starter) => ({
  type: types.API_V1_HGHFHGJH_CREATE_SUCCEEDED,
  response,
  starter
})
export const api_v1_hghfhgjh_createFailed = (error, starter) => ({
  type: types.API_V1_HGHFHGJH_CREATE_FAILED,
  error,
  starter
})
export const api_v1_hghfhgjh_read = () => ({ type: types.API_V1_HGHFHGJH_READ })
export const api_v1_hghfhgjh_readSucceeded = (response, starter) => ({
  type: types.API_V1_HGHFHGJH_READ_SUCCEEDED,
  response,
  starter
})
export const api_v1_hghfhgjh_readFailed = (error, starter) => ({
  type: types.API_V1_HGHFHGJH_READ_FAILED,
  error,
  starter
})
export const api_v1_hghfhgjh_update = data => ({
  type: types.API_V1_HGHFHGJH_UPDATE,
  data
})
export const api_v1_hghfhgjh_updateSucceeded = (response, starter) => ({
  type: types.API_V1_HGHFHGJH_UPDATE_SUCCEEDED,
  response,
  starter
})
export const api_v1_hghfhgjh_updateFailed = (error, starter) => ({
  type: types.API_V1_HGHFHGJH_UPDATE_FAILED,
  error,
  starter
})
export const api_v1_hghfhgjh_partial_update = data => ({
  type: types.API_V1_HGHFHGJH_PARTIAL_UPDATE,
  data
})
export const api_v1_hghfhgjh_partial_updateSucceeded = (response, starter) => ({
  type: types.API_V1_HGHFHGJH_PARTIAL_UPDATE_SUCCEEDED,
  response,
  starter
})
export const api_v1_hghfhgjh_partial_updateFailed = (error, starter) => ({
  type: types.API_V1_HGHFHGJH_PARTIAL_UPDATE_FAILED,
  error,
  starter
})
export const api_v1_hghfhgjh_delete = () => ({
  type: types.API_V1_HGHFHGJH_DELETE
})
export const api_v1_hghfhgjh_deleteSucceeded = (response, starter) => ({
  type: types.API_V1_HGHFHGJH_DELETE_SUCCEEDED,
  response,
  starter
})
export const api_v1_hghfhgjh_deleteFailed = (error, starter) => ({
  type: types.API_V1_HGHFHGJH_DELETE_FAILED,
  error,
  starter
})
