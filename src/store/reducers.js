...
export default function apiReducer(state = initialState, action) {
  switch (action.type) {
    ...
    case types.API_V1_HGHFHGJH_LIST:
    case types.API_V1_HGHFHGJH_LIST_SUCCEEDED:
    case types.API_V1_HGHFHGJH_LIST_FAILED:
      return Object.assign({}, state, {
        moctAPI: [...state.moctAPI, action.response]
      })
    case types.API_V1_HGHFHGJH_CREATE:
    case types.API_V1_HGHFHGJH_CREATE_SUCCEEDED:
    case types.API_V1_HGHFHGJH_CREATE_FAILED:
      return Object.assign({}, state, {
        moctAPI: [...state.moctAPI, action.response]
      })
    case types.API_V1_HGHFHGJH_READ:
    case types.API_V1_HGHFHGJH_READ_SUCCEEDED:
    case types.API_V1_HGHFHGJH_READ_FAILED:
      return Object.assign({}, state, {
        moctAPI: [...state.moctAPI, action.response]
      })
    case types.API_V1_HGHFHGJH_UPDATE:
    case types.API_V1_HGHFHGJH_UPDATE_SUCCEEDED:
    case types.API_V1_HGHFHGJH_UPDATE_FAILED:
      return Object.assign({}, state, {
        moctAPI: [...state.moctAPI, action.response]
      })
    case types.API_V1_HGHFHGJH_PARTIAL_UPDATE:
    case types.API_V1_HGHFHGJH_PARTIAL_UPDATE_SUCCEEDED:
    case types.API_V1_HGHFHGJH_PARTIAL_UPDATE_FAILED:
      return Object.assign({}, state, {
        moctAPI: [...state.moctAPI, action.response]
      })
    case types.API_V1_HGHFHGJH_DELETE:
    case types.API_V1_HGHFHGJH_DELETE_SUCCEEDED:
    case types.API_V1_HGHFHGJH_DELETE_FAILED:
      return Object.assign({}, state, {
        moctAPI: [...state.moctAPI, action.response]
      })
